...
(function () {
    ...
    const I18N = {
        'zh-CN': {
            ...
            api_key_placeholder: '输入你的 API Key', api_key_server_configured: '服务端已配置，可留空直接使用',
            ...
            ai_welcome_hint: '如服务端已配置 API Key 可直接对话，否则请在上方设置中填写。',
        ...
        'en': {
            ...
            api_key_placeholder: 'Enter your API Key', api_key_server_configured: 'Server configured — leave blank to use',
            ...
            ai_welcome_hint: 'If the server already has an API Key configured, you can chat directly; otherwise set it in Settings above.',
        ...
        'fr': {
            ...
            api_key_placeholder: 'Entrez votre clé API', api_key_server_configured: 'Serveur configuré — laisser vide',
            reasoning_toggle: '💭 Raisonnement',
            validate: 'Valider', validating: 'Validation...',
        ...
        'ja': {
            ...
            api_key_placeholder: 'APIキーを入力', api_key_server_configured: 'サーバー設定済み — 空欄で利用可',
            reasoning_toggle: '💭 思考過程',
